...
<body>
  ...
  <div class="wrapper">
      <section class="page-title container-fluid pt-4">
        <h1>News <span class="art">Detail</span></h1>
        <div aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">Main</a></li>
            <li class="breadcrumb-item"><a href="projects.html">News</a></li>
            <li class="breadcrumb-item active" aria-current="page">News 1</li>
          </ol>
        </div>
      </section>
