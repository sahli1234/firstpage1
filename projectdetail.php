 ...
 <!--  <header id="header">
  ...
  <div class="wrapper">
      <section class="page-title container-fluid pt-4">
        <h1>Project <span class="art">Detail</span></h1>
        <div aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">Main</a></li>
            <li class="breadcrumb-item"><a href="projects.html">All Projects</a></li>
            <li class="breadcrumb-item active" aria-current="page">Modern Architecture</li>
          </ol>
        </div>
      </section>
      <section class="container-fluid pt-5">
        <div class="projectdetail">
          <h5 class="text-uppercase">Private</h5>
        ...
        <div class="row projects">
          <div class="project col-lg-6 col-md-6">
            <a href="img/interior1.jpg" data-rel="lightcase">
              <img src="img/interior1.jpg" alt="">
            </a>
          </div>
          <div class="project col-lg-6 col-md-6">
            <a href="img/interior2.jpg" data-rel="lightcase">
              <img src="img/interior2.jpg" alt="">
            </a>
          </div>
          <div class="project col-lg-6 col-md-6">
            <a href="img/interior3.jpg" data-rel="lightcase">
              <img src="img/interior3.jpg" alt="">
            </a>
          </div>
          <div class="project col-lg-6 col-md-6">
            <a href="img/interior4.jpg" data-rel="lightcase">
